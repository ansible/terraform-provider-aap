	...
	resp.Schema = schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"variables": schema.StringAttribute{
				...
				Description: fmt.Sprintf("Variables of the %s. Will be either JSON or YAML string depending on how the variables were entered into AAP.", d.DescriptiveEntityName),
			},
		},
