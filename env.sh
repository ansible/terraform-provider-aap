...
export AAP_TEST_WORKFLOW_JOB_TEMPLATE_NAME="Demo Workflow Job Template" # needs inventory prompt on launch and default or nd demo inventory and a step with default job template.